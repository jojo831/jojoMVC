...
public class PodcastDaoJPA2Impl implements PodcastDao {
    ...
    public List<boardEntity> getPodcasts1(String orderByInsertionDate) {
        String sqlString = "SELECT p FROM boardEntity p";
//		if(orderByInsertionDate != null){
//			sqlString = "SELECT p FROM testEntity p" + " ORDER BY p.insertionDate " + orderByInsertionDate;
//		} else {
//			sqlString = "SELECT p FROM testEntity p";
//		}
        TypedQuery<boardEntity> query = entityManager.createQuery(sqlString, boardEntity.class);
    ...
    public List<boardEntity3> getPodcasts123(String param1, String param2, String param3) {
        String sqlString = "SELECT p FROM boardEntity3 p where p.tab1=? and p.tab2=? and p.tab3=?";
        TypedQuery<boardEntity3> query = entityManager.createQuery(sqlString, boardEntity3.class);
