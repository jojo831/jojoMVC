...
public class PodcastServiceDbAccessImpl implements PodcastService {
	...
	//added by jojo
	public List<boardXMLPOJO> getPodcasts1(String orderByInsertionDate, Integer numberDaysToLookBack) throws AppException {

		List<boardEntity> board = podcastDao.getPodcasts1("");
		List<boardXMLPOJO> response = new ArrayList<boardXMLPOJO>();

		for (boardEntity boardEntity1 : board) {
			response.add(new boardXMLPOJO(boardEntity1));
		}
		return response;
	}

	public List<testBoardPOJO> getPodcasts123(String param1,String param2,String param3) throws AppException {

		List<boardEntity3> board = podcastDao.getPodcasts123(param1,param2,param3);
		List<testBoardPOJO> response = new ArrayList<testBoardPOJO>();

		for (boardEntity3 boardEntity1 : board) {
			response.add(new testBoardPOJO(boardEntity1));
		}
		return response;
	}
