package org1.coding.demo.springmvc.FACADE;
...
public class Podcast2 implements Serializable {
    ...
    public Podcast2(testEntity podcastEntity) {
        try {
    ...
    public Podcast2(Long id, String url_description, String link_on_url, String sql_language, Date insertionDate) {
        this.id = id;
